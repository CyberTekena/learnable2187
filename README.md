...
A React interface concept for discovering emergency-service information, paramedics, and related resources. This repository is the `learnable2187` version in a family of related frontend iterations.
...
```sh
git clone https://github.com/CyberTekena/learnable2187.git
cd learnable2187
npm install
npm run dev
```
